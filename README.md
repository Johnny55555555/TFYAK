...
**Рисунок 6 — CFG функций main и square без оптимизации**
...
**Рисунок 7 — создание CFG для main.c после оптимизации -O2**

<img src="Скриншоты/С9.png" width="700">

**Рисунок 8 — CFG функции main после оптимизации -O2**
